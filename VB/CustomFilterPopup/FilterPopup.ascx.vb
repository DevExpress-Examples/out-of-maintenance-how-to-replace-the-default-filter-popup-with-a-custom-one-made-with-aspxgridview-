...
Namespace CustomFilterPopup
    Partial Public Class FilterPopup
        ...
        Private Sub PivotGrid_CustomCallback(ByVal sender As Object, ByVal e As PivotGridCustomCallbackEventArgs)
            Dim values() As String = e.Parameters.Split(",".ToCharArray())
            Dim field = PivotGrid.Fields.GetFieldByName(values(0))
            Dim newFilter = From v In field.GetUniqueValues() _
                            Where (Not values.Skip(1).Contains(Convert.ToString(v))) _
                            Select v
        ...
        Protected Sub ASPxGridView1_CustomCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridView.ASPxGridViewCustomCallbackEventArgs)
            Select Case e.Parameters
                ...
                Case Else
                    ...
                    For Each val As Object In CurrentField.FilterValues.ValuesIncluded
        ...
        Protected Sub ASPxGridView1_DataBinding(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Else
                Dim list = From v In CurrentField.GetUniqueValues() _
                           Select New FilterInfo() With {.FilterValue = Convert.ToString(v)}
...
"            }}", c.Field.ID, c.Field.Caption & " Filter")
        ...
        Public Sub InstantiateIn(ByVal container As Control) Implements ITemplate.InstantiateIn
            ...
            If c.Field.Area <> DevExpress.XtraPivotGrid.PivotArea.DataArea AndAlso c.Field.Options.AllowFilter <> DevExpress.Utils.DefaultBoolean.False Then
